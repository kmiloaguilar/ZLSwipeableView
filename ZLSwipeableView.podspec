Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "https://github.com/kmiloaguilar/ZLSwipeableView"
  s.screenshots  = "https://github.com/kmiloaguilar/ZLSwipeableView/raw/master/Previews/swipe.gif", "https://github.com/kmiloaguilar/ZLSwipeableView/raw/master/Previews/swipeLeft.gif"
  s.license      = { :type => "MIT", :file => "LICENSE" }
  s.author             = { "Zhixuan Lai" => "zhxnlai@gmail.com" }
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/kmiloaguilar/ZLSwipeableView.git", :tag => "0.0.8" }
